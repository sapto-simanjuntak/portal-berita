                                ...
                                <table class="table">
                                    <tbody>
                                        <tr>
                                            <td>
                                                <div class="flag">
                                                    <img src="{{ asset('back/img/flags/id.png') }}" alt="indonesia">
                                                </div>
                                            </td>
                                            <td>Indonesia</td>
                                            <td class="text-right">
                                        ...
                                        <tr>
                                            <td>
                                                <div class="flag">
                                                    <img src="{{ asset('back/img/flags/us.png') }}" alt="united states">
                                                </div>
                                            </td>
                                            <td>USA</td>
                                            <td class="text-right">
                                        ...
                                        <tr>
                                            <td>
                                                <div class="flag">
                                                    <img src="{{ asset('back/img/flags/au.png') }}" alt="australia">
                                                </div>
                                            </td>
                                            <td>Australia</td>
                                            <td class="text-right">
                                        ...
                                        <tr>
                                            <td>
                                                <div class="flag">
                                                    <img src="{{ asset('back/img/flags/ru.png') }}" alt="russia">
                                                </div>
                                            </td>
                                            <td>Russia</td>
                                            <td class="text-right">
                                        ...
                                        <tr>
                                            <td>
                                                <div class="flag">
                                                    <img src="{{ asset('back/img/flags/cn.png') }}" alt="china">
                                                </div>
                                            </td>
                                            <td>China</td>
                                            <td class="text-right">
                                        ...
                                        <tr>
                                            <td>
                                                <div class="flag">
                                                    <img src="{{ asset('back/img/flags/br.png') }}" alt="brazil">
                                                </div>
                                            </td>
                                            <td>Brasil</td>
                                            <td class="text-right">
